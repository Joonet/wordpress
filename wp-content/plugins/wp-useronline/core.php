...
class UserOnline_Core {
	...
	static function get_user_online_count() {
		...
		self::$useronline = self::shownInSite(self::$useronline);
		return self::$useronline;
	}


/***
     * To a certain extent increase the number of Online
     * @param integer $num_online
     * actual online number
     * @return int
     */
    static function shownInSite($num_online){
