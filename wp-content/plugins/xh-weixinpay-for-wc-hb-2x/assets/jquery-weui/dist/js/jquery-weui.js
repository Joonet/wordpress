  ...
  $.login = function(text, title, onOK, onCancel, username, password) {
    ...
    var modal = $.modal({
      text: '<p class="weui-prompt-text">'+(config.text || '')+'</p>' +
            '<input type="text" class="weui_input weui-prompt-input" id="weui-prompt-username" value="" placeholder="' + (config.username || '') + '" />' +
            '<input type="password" class="weui_input weui-prompt-input" id="weui-prompt-password" value="" placeholder="' + (config.password || '') + '" />',
      title: config.title,
      autoClose: false,
      buttons: [
      {
        text: config.buttonCancel,
        className: "default",
        onClick: function () {
          $.closeModal();
          config.onCancel && config.onCancel.call(modal);
