	...
	**/
	public function ToXml()
	{
		if(!is_array($this->values) 
			|| count($this->values) <= 0)
		{
    		throw new XH_Wx_Pay_Exception("数组数据异常！");
    	}
	...
	{	
		if(!$xml){
			throw new XH_Wx_Pay_Exception("xml数据异常！");
		}
        //将XML转为array
        //禁止引用外部xml实体
	...
	public function MakeSign()
	{
		...
		//签名步骤二：在string后加入KEY
		$string = $string . "&key=".XH_Wx_Pay_Config::$KEY;
		//签名步骤三：MD5加密
		$string = md5($string);
		//签名步骤四：所有字符转为大写
 ...
 *
 */
class XH_WECHAT_WxPayResults extends XH_Wx_Pay_Data
{
	/**
	 * 
	 * 检测签名
	...
	public function CheckSign()
	{
		//fix异常
		if(!$this->IsSignSet()){
			throw new XH_Wx_Pay_Exception("签名错误！");
		}
     ...
     * 
     */
	public static function Init($xml,$ignoreSign=false)
	{	
		$obj = new self();
		$obj->FromXml($xml);
		//fix bug 2015-06-29
 ...
 *
 */
class XH_Wx_Pay_Notify_Reply extends  XH_Wx_Pay_Data
{
	/**
	 * 
 ...
 *
 */
class XH_WECHAT_WxPayUnifiedOrder extends XH_Wx_Pay_Data
{	
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayOrderQuery extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayCloseOrder extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayRefund extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayRefundQuery extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayDownloadBill extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayReport extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayShortUrl extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxPayXH_Wx_Micro_Pay extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayReverse extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class WxPayXH_Wx_Pay_Js_Api extends XH_Wx_Pay_Data
{
	/**
	* 设置微信分配的公众账号ID
	* @param string $value 
 ...
 *
 */
class XH_WECHAT_WxPayBizPayUrl extends XH_Wx_Pay_Data
{
		/**
	* 设置微信分配的公众账号ID
	* @param string $value 
