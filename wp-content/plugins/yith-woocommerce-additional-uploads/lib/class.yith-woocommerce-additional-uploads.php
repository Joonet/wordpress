        ...
        public function show_upload_section ( $order_id ) {
            ...
            <span
                ...
                <?php if ( $this->allowed_extension ):
                    _e ( "Choose one of the following formats:", 'yith-woocommerce-additional-uploads' ); echo ' ' . $this->allowed_extension . '.'; ?>
                <?php endif; ?>
				</span>
            ...
            <form enctype="multipart/form-data" action="" method="POST">
                ...
                <div class="upload-items">
                    <input type="button" value="<?php _e ( "Select file", 'yith-woocommerce-additional-uploads' ); ?>"
                           id="do_uploadFile"/>
                    <input type="file" name="uploadFile[]" id="uploadFile" accept="image/*,.pdf"/>
                </div>
