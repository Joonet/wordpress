...
//  var backgroundColor = '#171717';
  ...
  this.initScene = function() {
	...
	progressBar.style.color='#0383fe';
	progressBar.innerHTML='正在渲染....';
  ...
  function loadPlaneGeometry() {    
    ...
    plane = new THREE.Mesh(new Plane(100, 100, 10, 10), new THREE.MeshBasicMaterial({color: 0xdddddd, opacity:0, wireframe:true}));
