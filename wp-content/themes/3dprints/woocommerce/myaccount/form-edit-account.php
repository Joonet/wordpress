...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first input-one">
		<label for="account_first_name"><?php _e( 'Name', 'woocommerce' ); ?> <span class="required">*</span></label>
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--last form-row form-row-last nodisplay">
	...
	<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row input-two">
		<label for="account_email"><?php _e( 'Email address', '3dprint' ); ?> <span class="required">*</span></label>
